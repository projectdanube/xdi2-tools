...
public abstract class AbstractGraphsCommand <T> extends AbstractMessagingTargetsCommand<T> implements Command {
	...
	protected void callbackMessagingTarget(String messagingTargetPath, MessagingTarget messagingTarget, HttpEndpointRegistry httpEndpointRegistry, T state) throws Exception {
